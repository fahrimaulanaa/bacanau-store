...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-slate-950/70 px-4 backdrop-blur-sm">
          <div className="w-full max-w-lg overflow-hidden rounded-2xl border border-white/20 bg-white shadow-2xl">
            <div className="p-6 sm:p-8">
              ...
              <p className="text-center text-sm font-black uppercase tracking-wide text-amber-600">Info Pesanan</p>
              ...
              <p className="mt-4 text-center text-base leading-7 text-slate-600">
                Pesanan anda saat ini sudah diproses oleh Vendor, diperkirakan dapat diambil sekitar
                <strong> 4 - 5 Juni 2026</strong>.
              </p>
            </div>
            <div className="border-t border-slate-100 p-6 sm:p-8">
              <Link
                href="/track"
                className="block w-full rounded-xl bg-amber-500 px-4 py-3 text-center text-sm font-black uppercase tracking-wide text-white transition-colors hover:bg-amber-600"
              >
                Lacak Pesanan
              </Link>
            </div>
      ...
      <a
        href="https://wa.me/6285174237980"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Hubungi admin via WhatsApp"
        className="fixed bottom-6 right-4 z-40 inline-flex items-center gap-2 rounded-full bg-green-500 px-4 py-3 text-sm font-bold text-white shadow-lg shadow-green-500/35 transition-colors hover:bg-green-600 sm:right-6"
      >
        <svg
          className="h-5 w-5"
          viewBox="0 0 24 24"
          ...
          aria-hidden="true"
        >
          <path d="M20.52 3.48A11.86 11.86 0 0012.07 0C5.51 0 .16 5.35.16 11.92c0 2.1.55 4.15 1.6 5.96L0 24l6.3-1.65a11.9 11.9 0 005.77 1.47h.01c6.56 0 11.91-5.35 11.91-11.92 0-3.18-1.24-6.17-3.47-8.42zm-8.45 18.34h-.01a9.88 9.88 0 01-5.03-1.38l-.36-.21-3.74.98 1-3.65-.24-.37a9.88 9.88 0 01-1.52-5.27C2.17 6.45 6.62 2 12.07 2c2.64 0 5.11 1.03 6.98 2.9a9.8 9.8 0 012.89 6.98c0 5.46-4.45 9.91-9.87 9.94zm5.43-7.41c-.3-.15-1.77-.87-2.05-.97-.27-.1-.47-.15-.67.15-.2.3-.77.97-.95 1.17-.17.2-.35.22-.64.07-.3-.15-1.24-.45-2.36-1.44a8.77 8.77 0 01-1.64-2.05c-.17-.3-.02-.45.13-.59.14-.14.3-.35.45-.52.15-.18.2-.3.3-.5.1-.2.05-.37-.03-.52-.08-.15-.67-1.62-.91-2.22-.24-.58-.5-.5-.67-.5h-.57c-.2 0-.52.08-.8.38-.27.3-1.04 1.01-1.04 2.47 0 1.45 1.07 2.86 1.22 3.05.15.2 2.1 3.2 5.1 4.49.71.3 1.27.48 1.7.61.72.23 1.38.2 1.9.12.58-.09 1.77-.72 2.02-1.41.25-.7.25-1.29.17-1.41-.08-.12-.27-.2-.57-.35z" />
        </svg>
